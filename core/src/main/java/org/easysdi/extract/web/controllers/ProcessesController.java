...
import org.easysdi.extract.plugins.implementation.TaskProcessorDiscovererWrapper;
...
public class ProcessesController extends BaseController {
    ...
    public final String updateItem(@Valid @ModelAttribute("process") final ProcessModel processModel,
        ...
        try {
            ...
            org.easysdi.extract.domain.Process domainProcess = this.processesRepository.findById(id).orElse(null);
