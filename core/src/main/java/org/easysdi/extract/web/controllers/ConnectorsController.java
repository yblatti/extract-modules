...
import org.easysdi.extract.connectors.implementation.ConnectorDiscovererWrapper;
...
public class ConnectorsController extends BaseController {
     ...
     */
    private static final String CURRENT_SECTION_IDENTIFIER = "org/easysdi/extract/connectors";

    /**
     * The string that identifies the view to display the information of a connector.
     */
    private static final String DETAILS_VIEW = "org/easysdi/extract/connectors/details";

    /**
     * The string that identifies the view to display all the connectors.
     */
    private static final String LIST_VIEW = "org/easysdi/extract/connectors/list";
